...
function Particle:draw()
    ...
    love.graphics.rectangle("line", self.location.x, self.location.y, 30, 30)
    --love.graphics.line(self.location.x1, self.location.y1, self.location.x2, self.location.y2)
